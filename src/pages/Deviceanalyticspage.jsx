...
const OS_DAILY = [
  { l: "May 1",  android: 520, ios: 210, windows: 55, other: 15 },
  { l: "May 6",  android: 680, ios: 280, windows: 72, other: 18 },
  { l: "May 11", android: 610, ios: 250, windows: 65, other: 16 },
  { l: "May 16", android: 760, ios: 310, windows: 88, other: 22 },
  { l: "May 21", android: 700, ios: 290, windows: 80, other: 19 },
  { l: "May 26", android: 810, ios: 330, windows: 95, other: 24 },
  { l: "May 31", android: 850, ios: 350, windows: 100, other: 26 },
];
const OS_WEEKLY = [
  { l: "W1", android: 3100, ios: 1320, windows: 345, other: 95 },
  { l: "W2", android: 3850, ios: 1640, windows: 428, other: 112 },
  { l: "W3", android: 3520, ios: 1500, windows: 392, other: 103 },
  { l: "W4", android: 4200, ios: 1780, windows: 467, other: 124 },
];
const OS_MONTHLY = [
  { l: "Jan", android: 12000, ios: 5100, windows: 1340, other: 360 },
  { l: "Feb", android: 14500, ios: 6200, windows: 1620, other: 430 },
  { l: "Mar", android: 13200, ios: 5600, windows: 1480, other: 392 },
  { l: "Apr", android: 16000, ios: 6800, windows: 1780, other: 472 },
  { l: "May", android: 17400, ios: 7360, windows: 1930, other: 512 },
];
...
const TOP_DEVICES = [
  { model: "Samsung Galaxy S24", os: "Android 14", scans: 2840, share: 100, icon: "📱" },
  { model: "iPhone 15 Pro",      os: "iOS 17",     scans: 2190, share: 77,  icon: "📱" },
  { model: "iPhone 14",          os: "iOS 16",     scans: 1650, share: 58,  icon: "📱" },
  { model: "Samsung Galaxy A54", os: "Android 13", scans: 1420, share: 50,  icon: "📱" },
  { model: "Google Pixel 8",     os: "Android 14", scans: 1180, share: 42,  icon: "📱" },
  { model: "OnePlus 12",         os: "Android 14", scans: 980,  share: 35,  icon: "📱" },
  { model: "iPad Pro",           os: "iPadOS 17",  scans: 760,  share: 27,  icon: "📟" },
  { model: "Redmi Note 13",      os: "Android 13", scans: 640,  share: 23,  icon: "📱" },
];

const OS_VERSIONS = [
  { version: "Android 14",  count: 9840, pct: 100, color: "#ef4444" },
  { version: "iOS 17",      count: 5420, pct: 55,  color: "#f87171" },
  { version: "Android 13",  count: 4120, pct: 42,  color: "#fca5a5" },
  { version: "iOS 16",      count: 2840, pct: 29,  color: "#fca5a5" },
  { version: "Android 12",  count: 1680, pct: 17,  color: "#fecaca" },
  { version: "Other",       count: 1462, pct: 15,  color: "#fee2e2" },
];

const SCREEN_DATA = [
  { range: "< 5\"",    count: 1240 },
  { range: "5–6\"",    count: 8420 },
  { range: "6–6.5\"",  count: 9180 },
  { range: "6.5–7\"",  count: 4320 },
  { range: "> 7\"",    count: 2202 },
];
...
export default function DeviceAnalyticsPage({ onMenuClick }) {
  ...
  const handleExport = () => {
    ...
    a.download = "device_analytics.csv"; a.click();
  ...
  const TABS = [
    ...
    { id: "devices",      label: "Top Devices",    Icon: Smartphone  },
    { id: "performance",  label: "Performance",    Icon: Activity    },
  ];

  const STATS = [
    { Icon: Smartphone, bg: "from-red-500 to-rose-600",  label: "Total Devices",    value: "25,362",  change: "+18.4%" },
    { Icon: Monitor,    bg: "from-rose-500 to-red-600",  label: "Unique Devices",   value: "17,890",  change: "+14.2%" },
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-[#fdf5f5]">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 px-3 sm:px-5 py-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-1">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-red-400 text-xs hidden sm:block">Breakdown of devices, OS, and performance metrics</p>
            </div>
          </div>
        ...
        {/* ── ROW 1: OS Breakdown stacked bar + Session Duration ── */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
          ...
          <div className={`bg-white border border-red-100 rounded-xl p-4 shadow-sm transition-opacity ${tab === "devices" || tab === "performance" ? "opacity-40 pointer-events-none" : ""}`}>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-red-900 font-semibold text-sm flex items-center gap-2">
                <Cpu className="w-4 h-4 text-red-500" />OS Distribution Over Time
              </h3>
          ...
          <div className={`bg-white border border-red-100 rounded-xl p-4 shadow-sm transition-opacity ${tab === "os" || tab === "devices" ? "opacity-40 pointer-events-none" : ""}`}>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-red-900 font-semibold text-sm flex items-center gap-2">
                <Clock className="w-4 h-4 text-red-500" />Avg Session Duration (min)
              </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          <div className={`transition-opacity ${tab === "devices" ? "opacity-40 pointer-events-none" : ""}`}>
            <DonutCard title="OS Share" Icon={Cpu} data={DEVICE_PIE} center="25,362" centerSub="Scans" />
          </div>
        ...
        {/* ── ROW 3: Top Devices Table + OS Versions + Screen Size ── */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">

          {/* Top Devices — spans 2 cols on lg */}
          ...
          {/* OS Versions + Screen Size stacked */}
              ...
              <div className="space-y-2.5">
                {OS_VERSIONS.map(v => (
                  <div key={v.version} className="flex items-center gap-2">
                    ...
                    <span className="text-red-900 text-[11px] font-bold w-12 text-right flex-shrink-0">{(v.count / 1000).toFixed(1)}k</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <ResponsiveContainer width="100%" height={130}>
                <BarChart data={SCREEN_DATA} margin={{ top: 4, right: 4, left: -20, bottom: 0 }} barCategoryGap="25%">
                  ...
                  <Bar dataKey="count" name="Devices" fill="#ef4444" radius={[4, 4, 0, 0]}
                    label={{ position: "top", fontSize: 7, fill: "#f87171", formatter: v => `${(v / 1000).toFixed(1)}k` }} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
        ...
        {/* ── ROW 4: Radar + Performance Stats ── */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">

          {/* Radar Chart — Device Capability Score */}
          <div className={`bg-white border border-red-100 rounded-xl p-4 shadow-sm transition-opacity ${tab === "devices" || tab === "os" ? "opacity-40 pointer-events-none" : ""}`}>
            ...
            <p className="text-red-400 text-[10px] mb-3">Comparative capability index across platforms</p>
          ...
          <div className={`bg-white border border-red-100 rounded-xl p-4 shadow-sm transition-opacity ${tab === "os" || tab === "devices" ? "opacity-40 pointer-events-none" : ""}`}>
            <h3 className="text-red-900 font-semibold text-sm mb-3 flex items-center gap-2">
              <Activity className="w-4 h-4 text-red-500" />Performance Metrics
            </h3>
